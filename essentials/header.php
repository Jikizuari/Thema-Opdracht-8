...
<body>
	<header>
		<section id="top">
			<div class="content">
				...
				<?PHP else: ?>
				<a class="right button" href="?page=logout">Uitloggen</a><a class="right button" href="?page=myaccount"><?PHP echo $_SESSION['user_name']." ".$_SESSION['user_lastname'] ?></a>
				<?PHP endif; ?>
			</div>
		</section>
	...
	<section id="main-content" class="content">
		<div class="left" id="main-content-left">
			<nav  id="sidemenu">
				<ul>
					<a href="?page=vakantie"><li><img src="img/icons/plane.png" alt="" />Boek uw vakantie</li></a>
